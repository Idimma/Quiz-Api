...
@section('content')
    ...
    <div class="row row-no-gutter">
        ...
        <div class="card radius-10 ml-auto mr-auto mt-4 col-md-10 col-sm-11 col-lg-9 col-xl-8">
            <div class="card-body px-lg-4 px-md-3 px-xl-5 py-3 pt-xl-5">
                <div style="min-height: 140px;"
                     class="d-flex justify-content-center align-items-center bg-gray radius-5 p-2 fade-in">
                ...
                <div class="row row-no-gutter">
                    <label for="a" class="form-check fade-in col-md-6">
                    ...
                    <label for="b" class="form-check fade-in  col-md-6">
                    ...
                    <label for="c" class="form-check fade-in  col-md-6">
                    ...
                    <label for="d" class="form-check fade-in  col-md-6">
                    ...
                    <label for="e" class="form-check fade-in  col-md-6 ">
            ...
            <div class="px-3  d-md-flex px-lg-4 px-md-3 px-xl-5 pb-2 justify-content-between">
                <p class="text-left text-danger " style="font-size: 60%">
                    Be sure before you check an answer, You only get one chance at it
                </p>
                <p class="text-md-right" style="font-size: 60%">
                    Name: {{$student->name??''}} &nbsp;
                    Type: {{$student->type??''}} &nbsp;
                    Level: {{$student->level??''}} &nbsp;
                </p>
